(function () {
    ...
    */
    ...
    /* demo/InputText.svelte generated by Svelte v3.43.0 */
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*id, keypath*/ 384) {
    			$$invalidate(10, accessor = [id, ...keypath]);
    		}

    		if ($$self.$$.dirty & /*data, accessor*/ 1088) {
    			$$invalidate(4, value = get(data, accessor) || '');
    		}

    		if ($$self.$$.dirty & /*errors, id, keypath*/ 896) {
    			// TODO
    			$$invalidate(3, error = errors && get(errors[id], keypath));
    		}

    		if ($$self.$$.dirty & /*accessor*/ 1024) {
    			/**
    ...
    /* demo/CarForm.svelte generated by Svelte v3.43.0 */
    ...
    // (85:3) {#each (data[wheel.id]?.relationships?.position?.data || []) as position}
    function create_each_block_1(ctx) {
    	...
    	inputtext.$on("formChange", /*formChange_handler_2*/ ctx[11]);

    	function click_handler() {
    		return /*click_handler*/ ctx[12](/*position*/ ctx[19]);
    	}
    	...
    	return {
    		...
    		p(new_ctx, dirty) {
    			...
    			if (dirty & /*data, wheels*/ 9) inputtext_changes.id = /*position*/ ctx[19].id;
    			if (dirty & /*data*/ 1) inputtext_changes.data = /*data*/ ctx[0];
    			if (dirty & /*readonly*/ 2) inputtext_changes.readonly = /*readonly*/ ctx[1];
    			if (dirty & /*errors*/ 4) inputtext_changes.errors = /*errors*/ ctx[2];
    ...
    function create_each_block(ctx) {
    	...
    	inputtext.$on("formChange", /*formChange_handler_1*/ ctx[10]);
    	let each_value_1 = /*data*/ ctx[0][/*wheel*/ ctx[16].id]?.relationships?.position?.data || [];
    	let each_blocks = [];
    	...
    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[13](/*wheel*/ ctx[16]);
    	}

    	function click_handler_2() {
    		return /*click_handler_2*/ ctx[14](/*wheel*/ ctx[16]);
    	}
    	...
    	return {
    		...
    		p(new_ctx, dirty) {
    			ctx = new_ctx;
    			const inputtext_changes = {};
    			if (dirty & /*wheels*/ 8) inputtext_changes.id = /*wheel*/ ctx[16].id;
    			if (dirty & /*data*/ 1) inputtext_changes.data = /*data*/ ctx[0];
    			if (dirty & /*readonly*/ 2) inputtext_changes.readonly = /*readonly*/ ctx[1];
    			if (dirty & /*errors*/ 4) inputtext_changes.errors = /*errors*/ ctx[2];
    			inputtext.$set(inputtext_changes);

    			if (dirty & /*removePosition, data, wheels, readonly, errors*/ 143) {
    				each_value_1 = /*data*/ ctx[0][/*wheel*/ ctx[16].id]?.relationships?.position?.data || [];
    				let i;
    ...
    function create_fragment$1(ctx) {
    	...
    	inputtext.$on("formChange", /*formChange_handler*/ ctx[9]);
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(button, "click", /*addWheel*/ ctx[4]);
    				mounted = true;
    			}
    		},
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*removeWheel, wheels, addPositionToWheel, data, removePosition, readonly, errors*/ 239) {
     ...
     */
    	...
    	const removeWheel = wheelId => dispatcher('removeResource', { id: wheelId, type: 'wheel' });
    	...
    	$$self.$$set = $$props => {
    		if ('carId' in $$props) $$invalidate(8, carId = $$props.carId);
     ...
     */
    			$$invalidate(3, wheels = data?.[carId]?.relationships?.wheels?.data || []);
    		}
    	};
    ...
    */
    ...
    /* demo/App.svelte generated by Svelte v3.43.0 */
    ...
    function create_fragment(ctx) {
    	...
    	let t16;
    	let pre;
    	let t17_value = JSON.stringify(/*form*/ ctx[0], undefined, 4) + "";
    	let t17;
    	let current;
    	let mounted;
    	let dispose;
    	...
    	carform = new CarForm({
    			props: {
    				carId: "001",
    				data: /*form*/ ctx[0]?.data,
    				readonly,
    				errors: /*errors*/ ctx[2]
    			}
    		});

    	carform.$on("formChange", /*formChange_handler*/ ctx[5]);
    	carform.$on("createResource", /*createResource_handler*/ ctx[6]);
    	carform.$on("removeResource", /*removeResource_handler*/ ctx[7]);

    	return {
    		c() {
    			p0 = element("p");
    			p0.textContent = "You would probably normally use your routing library or other framework tools to\n\tload data for a form, but here we're simulating it by \"fetching\" from a mock API.";
    			t1 = space();
    			button0 = element("button");
    			...
    			t12 = space();
    			p2 = element("p");
    			p2.innerHTML = `Here you can see what the <code>form</code> object looks like, as you modify it.`;
    			t16 = space();
    			pre = element("pre");
    			t17 = text(t17_value);
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(button0, "click", /*loadCar*/ ctx[4]);
    				mounted = true;
    			}
    		},
    		p(ctx, [dirty]) {
    			const carform_changes = {};
    			if (dirty & /*form*/ 1) carform_changes.data = /*form*/ ctx[0]?.data;
    			...
    			if ((!current || dirty & /*form*/ 1) && t17_value !== (t17_value = JSON.stringify(/*form*/ ctx[0], undefined, 4) + "")) set_data(t17, t17_value);
    		},
    		i(local) {
    			if (current) return;
